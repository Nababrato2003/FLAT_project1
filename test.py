...
# Step 2: Combine all inputs into one string
text = text_email + " " + text_phone + " " + text_url

# Step 3: Preprocess malformed URLs like www,google,com → www.google.com
text = re.sub(r'www,([a-zA-Z0-9\-]+),([a-z]{2,})', r'www.\1.\2', text)

# Step 4: Define regular expression patterns
...
# Step 6: Normalize phone numbers to always start with +91
phones = []
